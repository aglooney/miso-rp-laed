...
- **RP/ED**: single-window dispatch with ramp/reserve product-style constraints (commit the current interval)--like MISO
...
- `laed_rp_random_error.py`: stochastic (no-storage) experiments.
